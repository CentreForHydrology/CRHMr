...
#' @param waterYear Optional. If \code{FALSE} the fluxes are accumlated by calendar year. If \code{TRUE} the fluxes are accumulated by the water year, based on the first month of the model output.
#' @param logfile Optional. Name of the file to be used for logging the action. Normally not used.
#'
#' @return If successful, returns a data frame containing the date and the cumulative values of each variable. If unsuccessful, returns \code{FALSE}.
#' @author Kevin Shook
