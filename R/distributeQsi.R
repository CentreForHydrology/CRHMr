...
#' @param details Optional. If \code{TRUE} then the calculated atmospheric transmittance and extra-terrestrial radiation (\code{So_h_W}) will be returned along with the downscaled Qsi. If \code{FALSE} (the default) then only the Qsi values and the datetime are returned.
