...
#'
#' @description Finds spikes (short bursts of very large or small values) in the specified time variable.
#' @param obs Required. A \pkg{CRHMr} obs data frame.
#' @param colnum Optional. The number of the column to test for spikes, not including the \code{datetime}.
...
#'
#' @return If successful and there are no spikes, returns \code{0}. If there are spikes, returns their \code{datetime} values. If unsuccessful returns \code{FALSE}.
#' @author Kevin Shook
