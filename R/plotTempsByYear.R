...
#' @param tempCols Optional. Column(s) containing air temperatures. Can be a single value or a vector. Values will be recycled if necessary. Default is \code{1}.
...
#' @author Kevin Shook.
#' @seealso \code{\link{plotPrecipsByYear}}
#' @export
#'
