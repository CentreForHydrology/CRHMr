...
#' @param vars Optional. Variable column numbers to be used (not including the datetime). The default value \option{all}
#' selects all columns.
#' @param prjFile Required. The CRHM model .prj file.
#' @param HRUgroups Required. This can be either a vector or list. If a vector, it contains strings used to group the
#' selected HRU names in the .prj file. If a list, it contains vectors of the HRU numbers to be grouped. See the examples
#' for both usages.
#' @param basinMean Required. This refers to how the daily water values were calculated by \code{simpleDailyWater}. If \code{TRUE}
#' then the aggregated water depths/volumes are computed over the whole basin. If \code{FALSE} then the the aggregated
#' water depths/volumes are computed over area of the HRU groups.
#' @param quiet Optional. Suppresses display of messages, except for errors. The default is TRUE. If you are calling this
#' function in an R script, you will usually leave quiet=TRUE (i.e. the default). If you are working interactively, you will p
#' robably want to set \code{quiet = FALSE}.
