...
#' @param action Optional. The action used to replace the duplicate values. Must be one of \option{min}, \option{max}, \option{mean}, \option{skip}, \option{delete}, \option{split}. Default is \option{mean}.
