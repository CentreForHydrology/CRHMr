...
The second, more complex set of functions, are as developed by Craig Smith and Alan Barr of Environment Canada. Although their code is written in MATLAB, it is believed that this R code should give the same results.

If the weighing gauge is returning very high frequency (i.e. about every minute or more frequently), then you will want to filter the values using the function `weighingGauge3`.
